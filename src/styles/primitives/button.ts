...
const button = (props: ButtonProps = {}) => {
	...
	let cn = `inline-flex items-center rounded-full text-sm font-bold outline-2 -outline-offset-1 outline-primary focus-visible:outline disabled:pointer-events-none disabled:opacity-50`;
